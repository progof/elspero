...
### BIP173 (Bech32) Address support ("esc1..." addresses)
...
* A new field `iswitness` is True for P2WPKH and P2WSH addresses ("esc1..." addresses), but not for P2SH-wrapped segwit addresses (see below).
...
Testing changes
----------------
- The default regtest JSON-RPC port has been changed to 19443 to avoid conflict with testnet's default of 131756.
