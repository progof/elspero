...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 31755
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 131756
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 31757
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 31755
	%{_sbindir}/semanage port -d -p tcp 131756
	%{_sbindir}/semanage port -d -p tcp 31757
